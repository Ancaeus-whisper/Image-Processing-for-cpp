...
namespace test
{
   ...
   void SolidColorTest()
   {
      ...
      imwrite("output/SolidColor/½¥±ä.jpg",GradientColor(cv::Scalar(255,82,95),cv::Scalar(85,72,209),cv::Scalar(255,82,95),1,500,500));
   }
   ...
   void FilterTest()
   {
      ...
      imwrite("output/Filter/ÀæÉ³-OneLastKiss.jpg",OneLastKiss(image));
      imwrite("output/Filter/ÀæÉ³-OneLastKissReverse.jpg",OneLastKiss(image,OneLastKissMode::reverse));
   }
